...
class Bot_:
    ...
    async def send_message(
        ...
        try:
            ...
            print(f"{chat_id}:{ex.__class__.__name__}: {ex}")
    ...
    async def send_video_note(
        ...
        try:
            await Bot_.bot.send_video_note(
                chat_id,
                video_note,
                duration,
                length,
    ...
    async def delete_message(
        ...
        try:
            await Bot_.bot.delete_message(chat_id, message_id)
        except BaseException as ex:
            print(f"{chat_id}:{ex.__class__.__name__}: {ex}")

    async def get_title(chat_id: str | int) -> str:
        try:
            return (await Bot_.bot.get_chat(chat_id)).title
        except BaseException as ex:
            print(f"{chat_id}:{ex.__class__.__name__}: {ex}")
        return ""